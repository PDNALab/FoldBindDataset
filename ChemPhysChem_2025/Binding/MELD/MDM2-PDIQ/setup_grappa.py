...
def setup_system():
    ...
    s.restraints.add_selectively_active_collection(dists, int(len(dists)*0.22)) #>> 5 restraints
    ...
    atom_pdiq = s.index.atom(pdiq_center[0], 'CA', expected_resname=seq[pdiq_center[0]][-3:])
    conf_rest.append(
