...
def setup_system():
    ...
    s.restraints.add_selectively_active_collection(dists, int(len(dists)*0.11)) #>> 5 restraints
    ...
    atom_pdiq = s.index.atom(nsd3_center[0], 'CA', expected_resname=seq[nsd3_center[0]][-3:])
    conf_rest.append(
