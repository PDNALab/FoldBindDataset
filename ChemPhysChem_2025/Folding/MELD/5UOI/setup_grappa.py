...
##########################
    ...
    #dists = get_dist_restraints_strand_pair('strand_pair.dat', s, scaler, ramp, seq) #******************* as there is no strands ***********************
    ...
    #s.restraints.add_selectively_active_collection(dists, int(0.45*active))    #******************* as there is no strands ***********************
